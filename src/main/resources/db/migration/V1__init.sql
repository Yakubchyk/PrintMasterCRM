...
(
    ...
    one_ottisk_price              DECIMAL                                 NOT NULL,
    montage_work_price            DECIMAL                                 NOT NULL,
    one_quadrat_metter_foil_price DECIMAL                                 NOT NULL,
...
ALTER TABLE post_press
    ADD CONSTRAINT uc_postpress_lengthsm UNIQUE (lengthsm);

ALTER TABLE post_press
    ADD CONSTRAINT uc_postpress_montageworkprice UNIQUE (montage_work_price);

ALTER TABLE post_press
    ADD CONSTRAINT uc_postpress_oneottiskprice UNIQUE (one_ottisk_price);

ALTER TABLE post_press
    ADD CONSTRAINT uc_postpress_onequadratmetterfoilprice UNIQUE (one_quadrat_metter_foil_price);

ALTER TABLE post_press
    ADD CONSTRAINT uc_postpress_quantity UNIQUE (quantity);

ALTER TABLE post_press
    ADD CONSTRAINT uc_postpress_widthsm UNIQUE (widthsm);
